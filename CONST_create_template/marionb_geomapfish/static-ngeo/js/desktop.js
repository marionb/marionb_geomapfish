 ...
 *
 * This file defines the "marionb_geomapfish_desktop" Closure namespace, which is be used as
 ...
 */
goog.provide('marionb_geomapfish.DesktopController');
goog.provide('marionb_geomapfish_desktop');
 ...
 * @export
 */
marionb_geomapfish.DesktopController = function($scope, $injector) {
...
ol.inherits(marionb_geomapfish.DesktopController, gmf.AbstractDesktopController);


marionb_geomapfish.module.controller('DesktopController', marionb_geomapfish.DesktopController);
