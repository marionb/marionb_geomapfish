 ...
 *
 * This file defines the "geomapfish_desktop" Closure namespace, which is be used as
 ...
 */
goog.provide('geomapfish.DesktopController');
goog.provide('geomapfish_desktop');
 ...
 * @export
 */
geomapfish.DesktopController = function($scope, $injector) {
...
ol.inherits(geomapfish.DesktopController, gmf.AbstractDesktopController);


geomapfish.module.controller('DesktopController', geomapfish.DesktopController);
